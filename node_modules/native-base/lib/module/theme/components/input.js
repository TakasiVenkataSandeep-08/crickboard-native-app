...
const baseStyle = props => {
  ...
  return {
    ...
    borderColor: isInvalid ? mode('danger.600', 'danger.200')(props) : mode('gray.600', 'gray.400')(props),
...
function filledStyle(props) {
  ...
  return {
    ...
    borderWidth: 1,
    borderColor: isInvalid ? mode('danger.600', 'danger.200')(props) : 'transparent'
  };
}
