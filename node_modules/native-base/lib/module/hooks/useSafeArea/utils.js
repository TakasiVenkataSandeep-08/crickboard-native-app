...
function getValueInPixels(paddingProps, propKeys, sizes, inset, manualInset) {
  let appliedInset = 0;
  let originalValue = propKeys.length ? sizes[paddingProps[propKeys[propKeys.length - 1]]] : 0;
