...
export function findProps(props) {
  let [textProps, remaining] = themeTools.extractInObject(props, ['fontWeight', 'fontSize', 'textDecorationLine', 'color']);
  ...
  let [layoutProps, remainingProps] = themeTools.extractInObject(otherRemainingProps, ['m', 'margin', 'mt', 'marginTop', 'mr', 'marginRight', 'mb', 'marginBottom', 'ml', 'marginLeft', 'mx', 'marginX', 'my', 'marginY', 'left', 'top', 'bottom', 'right', 'position', 'minH', 'minHeight', 'minWidth', 'minW', 'height', 'width']);
