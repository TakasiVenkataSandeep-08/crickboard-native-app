...
const Collapse = ({
  ...
  const defaultStartHeight = isOpen ? endingHeight : startingHeight ? startingHeight : 0;
  let animatedStyle = {
  ...
  if (!(0, _isNil.default)(wasOpen.value) && wasOpen.value !== isOpen) {
    animateView();
  ...
  const _web = {
    transition: "height ".concat(duration !== null && duration !== void 0 ? duration : '400ms'),
