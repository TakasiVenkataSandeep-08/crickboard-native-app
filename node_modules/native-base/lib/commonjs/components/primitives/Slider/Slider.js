...
class NBSlider extends _react.default.PureComponent {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "panResponder", _reactNative.PanResponder.create({
  ...
  render() {
    ...
    }, _reactNative.Platform.OS === 'web' && this.props.isDisabled ? {
...
const Slider = ({ ...props
  ...
  const newProps = (0, _hooks.useThemeProps)('Slider', { ...formControlContext,
    ...props
  });
  return /*#__PURE__*/_react.default.createElement(NBSlider, newProps);
};

var _default = /*#__PURE__*/_react.default.memo(Slider);
